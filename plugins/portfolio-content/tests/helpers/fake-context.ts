 ...
 * `custom-plugin/tests/wordcount.spec.ts` pattern: a tiny in-memory
 * MCP server captures the registered handlers so each test can
 * invoke them directly, with no transport.
 */
