...
import type { Capability, HeroPanel, LanguageOption, PlaygroundStepDefinition, Technology, Telemetry } from './portfolio.types';

export const SOCIAL_ICONS = { github: siGithub, npm: siNpm } as const;
...
export const CAPABILITIES: readonly Capability[] = [
  { id: 'product', eyebrow: '01 / Product interfaces', title: 'Operational by design.', detail: 'Interfaces for people who use them all day: dense information, clear next actions and graceful empty states.', tools: ['Angular', 'SCSS', 'Responsive UI'], proof: 'Workflow interfaces · complex forms · interaction design' },
  { id: 'architecture', eyebrow: '02 / Angular architecture', title: 'Explicitly reactive.', detail: 'Standalone components, signals and typed boundaries make state changes understandable, testable and fast.', tools: ['Angular 22', 'Signals', 'Zoneless'], proof: 'Zoneless Calculator · production Angular patterns' },
  { id: 'mobile', eyebrow: '03 / Mobile delivery', title: 'One product, more surfaces.', detail: 'Web workflows designed for touch, constrained space and release-ready Android delivery — not simply shrunk desktop screens.', tools: ['Ionic', 'Capacitor', 'Android'], proof: 'Web + Android operational delivery' },
  { id: 'quality', eyebrow: '04 / Testing & quality', title: 'Confidence is a feature.', detail: 'A focused testing pyramid, semantic HTML and performance budgets keep product work reliable as it grows.', tools: ['Vitest', 'Accessibility', 'Performance'], proof: 'Unit → integration → dependable releases' },
  { id: 'systems', eyebrow: '05 / Design systems', title: 'Consistent, not repetitive.', detail: 'Flexible primitives turn a visual language into reusable, accessible interfaces without flattening every screen into a template.', tools: ['Tokens', 'CDK', 'Storybook'], proof: 'Reusable UI patterns · states · responsive rules' },
  { id: 'tooling', eyebrow: '06 / Developer tooling', title: 'The frontend has an engine room.', detail: 'Typed contracts, CLIs and MCP tooling turn repeated engineering work into dependable workflows for teams and agents.', tools: ['TypeScript', 'MCP', 'Docker'], proof: 'MCP Vertex · QuickModel · Keyer' },
];
...
export const TELEMETRY: readonly Telemetry[] = [
  { id: 'product', label: 'Product signal', title: 'A dashboard should reveal a decision.', value: '98%', valueLabel: 'workflow clarity', kpis: [['12', 'active patterns'], ['4.2h', 'saved per flow'], ['3', 'surfaces']], bars: [34, 46, 42, 68, 61, 78, 88, 96], note: 'Signals are grouped by workflow, not by a vanity metric.' },
  { id: 'quality', label: 'Quality signal', title: 'Quality is a visible operating metric.', value: '94%', valueLabel: 'critical flow coverage', kpis: [['0', 'blocking a11y issues'], ['18', 'checked states'], ['1.8s', 'interaction budget']], bars: [55, 58, 71, 67, 79, 85, 89, 94], note: 'Testing, semantics and performance share the same delivery conversation.' },
  { id: 'delivery', label: 'Delivery signal', title: 'One interface, more than one surface.', value: '2×', valueLabel: 'web + Android delivery', kpis: [['7', 'release checkpoints'], ['3', 'deployment paths'], ['99.9%', 'workflow availability']], bars: [30, 38, 58, 55, 72, 69, 84, 91], note: 'Responsive product work considers the next device before it becomes a rewrite.' },
];
